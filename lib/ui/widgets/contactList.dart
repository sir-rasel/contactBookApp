...
class _ContactsListState extends State<ContactsList> {
  ...
  void initState() {
    ...
    contactsDBHelper.getContacts(email).then((value) => setState(() {
          contacts = value;
          for (var item in contacts) items.add(item);
        }));
  ...
  void filterContact(String searchTerm) {
    var tmpSearchList = [];
    for (var item in items) tmpSearchList.add(item);
    ...
    if (searchTerm.isNotEmpty) {
      ...
      setState(() {
        contacts.clear();
        for (var item in tmpList) contacts.add(item);
      });
      return;
    } else {
      setState(() {
        contacts.clear();
        for (var item in items) contacts.add(item);
      });
    }
  }
          ...
          children: <Widget>[
            ...
            Card(
              child: ListTile(
                ...
                onTap: () {
                  setState(() {
                    items.sort((a, b) => a.phone.compareTo(b.phone));
